...
pretrained_model = './exp-referit/tfmodel/referit_fc8_segment_highresolution_initialization.tfmodel'

# Training Params
positive_loss_multiplier = 1.
negative_loss_multiplier = 1. / 3

start_learningrate = 0.01
learningrate_decay_step = 6000
...
regularization_loss = loss.l2_regularization_loss(reg_variable_list, weight_decay)
